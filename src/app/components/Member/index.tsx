    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className={`absolute -inset-3 rounded-full bg-gradient-to-r from-brand-orange via-brand-orange-light to-brand-orange blur-md transition-opacity duration-300 pointer-events-none ${
          ...
          <div
            className={`relative w-[200px] h-[200px] md:w-[250px] md:h-[250px] rounded-full overflow-hidden transition-shadow duration-300 ${
              isHovered ? "ring-4 ring-brand-orange/80" : ""
            }`}
          >
      ...
      {isOpen && (
        <MemberPopup onClose={() => setIsOpen(false)} image={image}>
          ...
          {linkedin && (
            <a
              className="mt-6 inline-flex items-center gap-2 px-4 py-2 bg-primary/20 rounded-full hover:bg-brand-orange/40 transition-all"
              href={linkedin}
              target="_blank"
